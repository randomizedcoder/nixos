#
# arm/pi-bob/nix/sshd.nix
#
# ============================================================================
# INSECURE DEMO - password SSH login is ENABLED.
#
# So that Bob can SSH in immediately with the demo passwords (see ./users.nix)
# even before he has added an SSH key, password authentication is turned on and
...
#   3. Rebuild:  sudo nixos-rebuild switch --flake .#pi-bob
# ============================================================================
#
