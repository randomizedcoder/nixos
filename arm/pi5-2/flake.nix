...
# arm/pi5-2/flake.nix
#
# NixOS config for the Raspberry Pi 5 "pi5-2".
...
#   nixos-rebuild switch --flake .#pi5-2 --target-host root@<pi-ip>
#
{
  description = "pi5-2 - Raspberry Pi 5";
  ...
  outputs =
    ...
    in
    {
      nixosConfigurations = {
        ...
        #   nixos-rebuild switch --flake .#pi5-2 --target-host root@<pi-ip>
        pi5-2 = nixos-raspberrypi.lib.nixosSystem {
          specialArgs = inputs;
          modules = baseModules;
        };
        ...
        pi5-2-sdimage = nixos-raspberrypi.lib.nixosSystem {
          specialArgs = inputs;
          modules = baseModules ++ [
