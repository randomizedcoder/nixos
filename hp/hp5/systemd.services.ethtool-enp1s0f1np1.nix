# Per-NIC ethtool tuning for the X710 port enp1s0f1np1.
#
# Replaces the legacy systemd.services.ethtool-enp3s0f1.nix (interface
# was renamed enp3s0f1 → enp1s0f1np1 when the X710 moved PCIe slots and
