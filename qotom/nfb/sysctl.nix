...

{
  ...
  boot.kernel.sysctl = {
    ...
    "net.ipv4.tcp_rto_min_us" = 10000; #10ms
    ...
    "net.netfilter.nf_conntrack_max" = 262144;                    # Maximum connection tracking entries
    "net.netfilter.nf_conntrack_tcp_timeout_established" = 10800;  # 3 hours (was 24 hours)
    ...
    "net.netfilter.nf_conntrack_tcp_timeout_fin_wait" = 120;       # 2 minutes
    "net.netfilter.nf_conntrack_udp_timeout" = 30;                 # 30 seconds (general UDP timeout)
    "net.netfilter.nf_conntrack_udp_timeout_stream" = 180;         # 3 minutes (UDP streams like DNS queries)

    # Kernel Security Features
    # Reverse Path Filtering - prevents IP spoofing attacks
    # "net.ipv4.conf.all.rp_filter" = 1;
    # "net.ipv4.conf.default.rp_filter" = 1;
    # disable for keepalived testing
    #"net.ipv4.conf.all.rp_filter" = 0;
    #"net.ipv4.conf.default.rp_filter" = 0;

    # Martian Packet Logging - logs spoofed packets for attack detection
