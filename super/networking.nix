...
let
  ...
  # Jumbo frames. The ToR fabric L2 is 9216; host IP-MTU 9000 leaves headroom for the
  # 802.1q tag (9000 + 14 eth + 4 tag = 9018 < 9216). Only enable AFTER both leaves
  # carry the network-qos JUMBO policy, or oversized frames blackhole on the switch.
  mtu = 9000;
in
{
